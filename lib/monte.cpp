...
void circles_singular_points_map(long double** q, long double** u, long double** qx, long double** ux,
                                 long double** qy, long double** uy, int** whitelist, long double** out_map, unsigned int type) {
    ...
    for (unsigned int j_ring = 0; j_ring < nring / 2; ++j_ring) {
        ...
        for (unsigned int i_ring = 0; i_ring < nphi; ++i_ring) {
            ...
            if (flag == 1) {
                v1 = singular_points_classifier_area(q, u, qx, ux, qy, uy, whitelist, npix / 4 + j_center,
                                                     npix / 4 + j_center + static_cast<unsigned int>(hring / sinl(theta)) - 1,
                                                     i_center,
                                                     i_center + hphi - 1, type);

                v2 = singular_points_classifier_area(q, u, qx, ux, qy, uy, whitelist, 1,
                                                     npix / 4 - j_center - 1,
                                                     i_center,
                                                     i_center + hphi - 1, type);
                ...
                v2 = singular_points_classifier_area(q, u, qx, ux, qy, uy, whitelist, npix / 4 - j_center - static_cast<unsigned int>(hring / sinl(theta)),
                                                     npix / 4 - j_center - 1,
                                                     i_center,
                                                     i_center + hphi - 1, type);
